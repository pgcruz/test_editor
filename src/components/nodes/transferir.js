...
const Transferir = ({ onDelete }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <Icons.ForumOutlined style={iconStyle} /> Transferir Chat
        </div>
      </div>
      {!isMinimized && (
        <>
          <div className="text-m p-4 bg-[#FBF8FD] w-[383px] h-[422px] rounded-lg relative flex flex-col justify-between mt-[-4rem]">
            ...
            >
              <div className="m-[-1.5rem] p-2 text-[#001452]">
                <Icons.ForumOutlined /> Transferir Chat
            ...
            <div className="fixed top-[50px]">
              ...
              <textarea className='resize-none w-[314px] h-[36px] bg-[#EFEDF1] rounded-[10px] p-2' placeholder='Escribe el asunto' />
